    ...
    <main className="min-h-screen bg-slate-900 text-white flex flex-col items-center justify-center p-8">
      ...
      >
        ...
        <p className="mt-6 text-slate-400 max-w-2xl text-center">
          Computer Engineering graduate, specialized in Software Engineering &
          AI. I build intelligent systems and scalable web applications.
        </p>
        <div className="mt-8 flex gap-4">
          ...
          <Link
            className="flex items-center gap-2 px-6 py-3 border border-slate-700 hover:bg-slate-800 rounded-lg font-medium transition"
            href="/cv_public.pdf"
            target="_blank"
          >
            Download CV
      ...
      <section id="projects" className="max-w-6xl mx-auto px-8 pb-24">
        ...
        <div className="text-center mt-12">
          <Link
            ...
            target="_blank"
            className="inline-flex items-center gap-2 px-6 py-3 border border-slate-700 hover:bg-slate-800 rounded-lg font-medium transition text-slate-300 hover:text-white"
          >
